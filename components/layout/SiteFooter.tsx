...
export function SiteFooter() {
  return <footer className="site-footer"><div className="shell footer-grid">
    ...
    <div className="footer-links"><b>Explore</b><Link href="/markets"><BilingualText zh="市场终端" en="Markets" /></Link><Link href="/options"><BilingualText zh="期权市场" en="Options" /></Link><Link href="/indices"><BilingualText zh="主题指数" en="Indices" /></Link><Link href="/research"><BilingualText zh="研究文章" en="Research" /></Link><Link href="/about"><BilingualText zh="关于我" en="About" /></Link></div>
